...
const style = {
    wrapper : `flex-[0.7] px-8 flex flex-col`, // place component into the side column 
    twitterIconContainer: `text-3xl m-4`,
    tweetButton: `bg-[#1d9bf0] hover:bg-[#1b8cd8] flex items-center justify-center font-bold rounded-3xl h-[50px] mt-[20px] cursor-pointer`,
    navContainer: `flex-1`,
    profileButton: `flex items-center mb-6 cursor-pointer hover:bg-[#333c45] round`,
    ...
    name:`text-lg`,
    handle:`text-[#8899a6]`, 
    moreContainer: `flex item-center mr-2`,
}


function Sidebar(intialSelectedIcon='Home') {
    const [selected, setSelected] = useState('Home') // To keep track of state of selceted pages 
    return(
        <div className={style.wrapper}>  
            ...
            <div className={style.navContainer}>
              ...
              />
               <SidebarOption Icon={selected === 'List' ? RiFileList2Fill  : FaRegListAlt }
                text = "List"
            ...
            <div className={style.profileButton}>
              ...
              <div className={style.profileRight}>
                <div className={style.details}>
                  <div className={style.name}>GenZTech</div>
                  <div className={style.handle}>@0*22dF...5xf2df</div>
              </div>
